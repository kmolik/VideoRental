package com.videoApp.manager;

import com.videoApp.dao.VideoCassetteRepo;
...
public class VideoCassetteManager
{
    ...
    public void fillDB()
    {
        save(new VideoCassette(1L, "Titanic", LocalDate.of(1998, 1, 1)));
        save(new VideoCassette(2L, "Pulp Fiction", LocalDate.of(1995, 12, 20)));
    }
}
